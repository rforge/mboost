...
Boosting for generalised additive models with constraints is discussed in
`r Citet(bib, "Hofner_Kneib_Hothorn_2015")`. Unbiased model selection in
generalised additive models is developed in `r Citet(bib, "Hofner_Hothorn_Kneib_2015")`.
